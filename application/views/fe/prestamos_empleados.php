<div class="content_block employees_loans">
	...
	<div class="l_column">		
			<span class="first_tag">
				Pr&eacute;stamo creado el: </span>
	...
	<div class="r_column">
        ...
        <BR/>
	<div class="l_column">
		<span class="first_tag"># Empleado:</span> 
	...
	<BR/>
	<div class="l_column">
		<span class="first_tag">Estatus:</span>
		<span name="loan_status" id="saving_status">
			<?php echo $this->ahorro->getStatus($prestamo->status, array('','activo','excento','cerrado'));?>
		</span> 
	</div>
<!--
