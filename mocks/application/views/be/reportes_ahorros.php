...
<div class="content_block">
	...
	<p class="week_data">Semana 03 (16 enero - 22 enero de 2012</p>
	
	<table class="report_table">
		<tr>
			<th class="column_report_id_employee"><span># De Empleado</span> 
			...
			<th class="column_report_employee_name"><span>Nombre</span> 
					<span class="sort_arrows">
						<a href="#" title="Ordenar descendentemente"><img
						src="../resources/images/arrow_down.png" alt="&darr;"
						class="sort_arrow_desc" /> </a> <a href="#" title="Ordenar ascendentemente"><img
			...
			<th class="column_report_savings"><span>Monto ahorrado</span> 
					<span class="sort_arrows">
						<a href="#" title="Ordenar descendentemente"><img
						src="../resources/images/arrow_down.png" alt="&darr;"
						class="sort_arrow_desc" /> </a> <a href="#" title="Ordenar ascendentemente"><img
			...
			<th class="column_report_percentaje_savings"><span>% De pr&eacute;stamos</span> 
					<span class="sort_arrows">
						<a href="#" title="Ordenar descendentemente"><img
						src="../resources/images/arrow_down.png" alt="&darr;"
						class="sort_arrow_desc" /> </a> <a href="#" title="Ordenar ascendentemente"><img
			...
			<th class="column_report_percentaje_bank"><span>% De banco</span> 
					<span class="sort_arrows">
						<a href="#" title="Ordenar descendentemente"><img
						src="../resources/images/arrow_down.png" alt="&darr;"
						class="sort_arrow_desc" /> </a> <a href="#" title="Ordenar ascendentemente"><img
			...
			<th class="column_report_final_amount"><span>Monto final</span> 
					<span class="sort_arrows">
						<a href="#" title="Ordenar descendentemente"><img
						src="../resources/images/arrow_down.png" alt="&darr;"
						class="sort_arrow_desc" /> </a> <a href="#" title="Ordenar ascendentemente"><img
...
<p class="print_button export_button">
	<a href="#" title="Imprime esta p&aacute;gina" class="export_btn">Exportar</a> <a href="#" title="Imprime esta p&aacute;gina">Imprimir</a>
</p>